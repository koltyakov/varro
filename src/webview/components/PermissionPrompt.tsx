...
export function PermissionPrompt(props: { permission: Permission }) {
  ...
  return (
    <div class="mx-3 my-2 rounded-md border border-vscode-warning/25 bg-vscode-warning/[0.04] px-3 py-3 animate-fade-in">
      <div class="mb-1.5 flex items-center gap-2">
        <svg class="h-4 w-4 shrink-0 text-vscode-warning" viewBox="0 0 16 16" fill="currentColor">
      ...
      <div class="mb-2 text-[12px] leading-[1.5] text-vscode-fg">{props.permission.title}</div>
