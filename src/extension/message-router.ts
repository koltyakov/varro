...
export class MessageRouter {
    ...
    try {
      switch (msg.type) {
        ...
        case 'providers/auth-changed':
          await this.callbacks.providerAuthChanged();
          break;
        ...
        case 'usage/report':
          ...
          break;
        case 'webview/reload':
          await this.callbacks.reloadWebview();
          break;
  ...
  private async handleProvidersRefreshMessage() {
    await this.callbacks.refreshProviders();
  }
