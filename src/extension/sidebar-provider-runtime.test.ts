/* oxlint-disable anti-slop/no-module-mocking, anti-slop/no-unknown-parameters, anti-slop/no-unknown-returns -- These runtime tests verify extension-host module wiring and opaque request forwarding. */
