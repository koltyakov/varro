...
7. Keep `MINIMUM_SUPPORTED_OPENCODE_VERSION` unchanged unless Varro starts relying on an API introduced after the current floor. The SDK dependency version records the latest tested version. It does not cap runtime support or automatic updates.
