      ...
      >
        <div class="max-h-[320px] overflow-y-auto py-1">
          <Show
            ...
            fallback={
              <div class="px-3 py-6 text-center text-[11px] text-vscode-muted">No models available</div>
            }
          >
                        ...
                        <>
                          ...
                          <Show when={!hasVariants()}>
                            ...
                            >
                              ...
                              <span class="min-w-0 flex-1 truncate text-vscode-fg">{model.name}</span>
                              ...
                              {(variant) => (
                                ...
                                >
                                  ...
                                  <span class="min-w-0 flex-1 truncate text-vscode-fg">
                                    {model.name}
                                    <span class="ml-1 text-vscode-muted/50">· {formatThinkingLabel(variant)}</span>
                                  </span>
                                  <Show when={model.limit?.context}>
                                    <span class="shrink-0 text-[10px] text-vscode-muted/40">
                                      {formatContextLimit(model.limit!.context)}
