...
- OpenCode CLI incompatible: `1.16.0` is the runtime floor. `1.18.30` is the version tested with this Varro release, not a runtime maximum. Newer versions are allowed to run and remain eligible for updates.
