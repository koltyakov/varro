...
| --- | --- | --- | --- |
| v2, recommended | 2.0.5 | 2.0.12 | `@opencode/cli` |
...
- OpenCode CLI incompatible: Varro supports the v1 API from `1.16.0` and the v2 API from `2.0.5`. This release was tested with v1 `1.18.31` and v2 `2.0.12`. Varro selects the API automatically, including when `varro.server.command` points to a custom binary such as `opencode2`. Updates use the installed CLI's package family.
